                  ...
                  <div>
                    <div class="container">
                      ...
                      <div class="fluid-container">
                        <div class="row">
                          <div class="col-md-2 col-xs-6">
                            <label>Date</label><input class="form-control" type="date" id="indate" name="indate" min="2015-07-01">
                          </div>
                          <div class="col-md-2 col-xs-6">
                            <label>Time</label> <input class="form-control" type="time" id="intime" name="intime" min="2015-07-01">
                          </div>
                        </div>
                      </div>
